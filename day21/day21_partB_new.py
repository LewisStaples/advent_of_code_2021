...
playerOneCount = game_outcome_dict[Roll_Input(InitialPlayerOneScore=0, InitialPlayerTwoScore=0, PlayerOneSpace=4, PlayerTwoSpace=8)].PlayerOneWinCount
playerTwoCount = game_outcome_dict[Roll_Input(InitialPlayerOneScore=0, InitialPlayerTwoScore=0, PlayerOneSpace=4, PlayerTwoSpace=8)].PlayerTwoWinCount

print('Part B sample results are: ')
print('Player One Win Count: ', end='')
print(playerOneCount)
print('Player Two Win Count: ', end='')
print(playerTwoCount)

print('The value to submit is (the greater of the above): ', end='')
print(max(playerOneCount, playerTwoCount))
